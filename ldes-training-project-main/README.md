...
**1. Create a new GitHub repository (`ldes-training-project`), and create the repository structure.**
...
|------|------------------------|
| `pipeline/shape.ttl` | `<your-username>` in the `NodeShape` IRI |
| `pipeline/metadata.ttl` | `<your-username>` in the stream IRI and shape reference |
| `pipeline/rdfc-pipeline-corporate-body.ttl` | `<your-username>` in `cb-as:` prefix and `js:nodeShapeIri` |
...
<https://<your-username>.github.io/ldes-training-project/shape.ttl#ActivityShape> a sh:NodeShape ;
...
`pipeline/metadata.ttl` : describes the LDES stream (replace `<your-username>`):
...
<https://<your-username>.github.io/ldes-training-project/corporate-body/CorporateBodyStream>
    a                     sds:Stream ;
    ...
    sds:shape             <https://<your-username>.github.io/ldes-training-project/shape.ttl#ActivityShape> ;
...
`pipeline/rdfc-pipeline-corporate-body.ttl` : the main pipeline definition (replace `<your-username>`):
...
@prefix as:   <https://www.w3.org/ns/activitystreams#>.
@prefix cb-as:  <https://<your-username>.github.io/ldes-training-project/corporate-body/>.
...
[ ] a js:DumpsToFeed;
    ...
    js:nodeShapeIri "https://<your-username>.github.io/ldes-training-project/shape.ttl#ActivityShape";
...
Your first LDES feed will be live at: `https://<your-username>.github.io/ldes-training-project/`
